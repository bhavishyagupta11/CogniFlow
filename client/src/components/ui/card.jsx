...
function Card({ className, ...props }) {
    return (<div data-slot="card" className={cn("bg-[var(--panel-bg)] text-[var(--text-primary)] flex flex-col gap-4 rounded-[4px] border border-[var(--panel-border)] p-4 shadow-none", className)} {...props}/>);
}
